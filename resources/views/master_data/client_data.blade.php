                ...
                <tbody>
                    @foreach($client_data as $c)
                        <tr>
                            ...
                            <td><button class="btn btn-primary start_status" id="{{$c->rid}}">Click Here To Activate</button></td>
                            <?php } else { ?>
                            <td><button class="btn btn-danger end_status" id="{{$c->rid}}">Click Here To Deactivate</button></td>
                            <?php } ?>
                        </tr>
                    @endforeach
                </tbody>
