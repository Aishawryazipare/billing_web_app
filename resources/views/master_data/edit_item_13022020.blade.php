              ...
              <form action="{{ url('edit-item') }}" method="POST" id="type_form" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="cat_name" placeholder="Item" name="item_name" value="{{$item_data->item_name}}" maxlength="50" required>
                        </div>
                        <label for="lbl_cat_name" class="col-sm-2 control-label">Rate<span style="color:#ff0000;">*</span></label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control rate_cal number" id="rate" placeholder="Item Rate" name="item_rate" value="{{$item_data->item_rate}}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="lbl_cat_desc" class="col-sm-2 control-label">Discount %<span style="color:#ff0000;">*</span></label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control rate_cal number" id="disc" placeholder="Item Disc" name="item_dis" value="{{$item_data->item_dis}}" required>
                        </div>
                         <label for="lbl_cat_desc" class="col-sm-2 control-label">Discount Rate</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control rate_cal number" id="disc_rate" placeholder="Disc Rate" name="item_disrate" value="{{$item_data->item_disrate}}" required>
                        </div>
                    </div>
                     <div class="form-group">
                        <label for="lbl_cat_desc" class="col-sm-2 control-label">Tax<span style="color:#ff0000;">*</span></label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control rate_cal number" id="tax" placeholder="Tax" name="item_tax" value="{{$item_data->item_tax}}" required>
                        </div>
                         <label for="lbl_cat_desc" class="col-sm-2 control-label">Tax Value</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control rate_cal number" id="tax_value" placeholder="Tax value" name="item_taxvalue" value="{{$item_data->item_taxvalue}}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="lbl_cat_desc" class="col-sm-2 control-label">Final Rate</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control final_rate number" id="final_rate" placeholder="Final Rate" name="item_final_rate" value="{{$item_data->item_final_rate}}"  readonly required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control number" id="cat_name" placeholder="Stock" name="item_stock" value="{{$item_data->item_stock}}">
                        </div>
                    </div>
                         <div class="form-group">
