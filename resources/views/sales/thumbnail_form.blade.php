            ...
            <div class="col-md-6 table-responsive" id="print_content">
                ...
                <div class="box box-default tbl_width_oveflow">
                    <div class="box-body">
                        <div id="set_header">
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td class='print_1' style="text-align: right;"><b>Date: <?php echo date('Y-m-d'); ?>
                                            <?php
                        ...
                        <input type="hidden" id="bil_no" name="bil_no" value="<?php if (isset($bill_data->bill_no)) echo $bill_data->bill_no;
                                                                                else echo "1"; ?>">
                        <h4 align="center" id="bill_no">Bill No:
                            <?php if (isset($bill_data->bill_no)) echo ($bill_data->bill_no + 1);
                            else echo "1"; ?></h4>
                        <div class="row">
                    ...
                    <div class="box-footer">
                        ...
                        @endif
                        <?php if (isset($bill_data->bill_no)) $b_no = $bill_data->bill_no;
                        else $b_no = "1"; ?>
