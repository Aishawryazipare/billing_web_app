...
<!--            <div class="box-header with-border">
              ...
              <div class="box-body">
                  ...
                  <?php }$all=0; ?>
                    <button type="button" class="btn btn-success btn-lg" id="btn_submit1" name="btn_submit" style="background-color:#00ffc3;color:black;margin-top: -5px;font-weight:bold;height:50px;font-size:14px;width:96px;" onclick="get_items(<?php echo $all;?>),0">All Items</button>
                    <br/>
                    <br/>
