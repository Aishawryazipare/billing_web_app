                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="name" placeholder="Employee Name"
                                value="{{$userData->name}}" name="name" required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="mobile_no" placeholder="Mobile No"
                                value="{{$userData->mobile_no}}" name="mobile_no" required maxlength="10">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control" id="address" placeholder="Address" name="address"
                                style='resize: vertical; max-width: 600px; min-width: 200px;'
                                required>{{$userData->address}}</textarea>
                        </div>
                    </div>
                </div>
