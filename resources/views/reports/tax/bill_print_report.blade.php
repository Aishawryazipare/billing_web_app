@extends('layouts.app')
@section('title', 'Bill Print Report')
@section('content')
<style>
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Bill Print Report</li>
  </ol>
</section>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box" style="border-top: 3px solid #ffffff;border: 2px solid #00ffc3;">
        ...
        <form class="form-horizontal" id="userForm" method="post" action="{{ url('download_bill_print_report') }}">
          {{ csrf_field() }}
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <div class="input-group date">
                  ...
                  <input type="text" name="from_date" class="form-control mobile_date datepicker from_date"
                    id="from_date" style="background-color: #ffffff;" autocomplete="off"
              ...
              <div class="col-sm-4">
                <div class="input-group date">
                  ...
                  <input type="text" name="to_date" class="form-control mobile_date datepicker to_date" id="to_date"
                    style="background-color: #ffffff;" value="<?php echo date('Y-m-d');?>" autocomplete="off" />
                </div>
              </div>
            </div>
          ...
          <div class="box-footer">
            ...
            <a href="{{url('bill_print_report')}}" class="btn btn-danger">Cancel</a>
          </div>
        </form>
      </div>
    </div>
