  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box" style="border-top: 3px solid #ffffff;border: 2px solid #00ffc3;">
        ...
        <form class="form-horizontal" id="userForm" method="post" action="{{ url('download_payment_report') }}">
          {{ csrf_field() }}
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <div class="input-group date">
                  ...
                  <input type="text" name="to_date" id="to_date" class="form-control mobile_date datepicker to_date"
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <select class="form-control select2 employee" style="width: 100%;" name="employee" id="employee">
                  ...
                  <option value="{{$u->payment_type}}">{{$u->payment_type}}</option>
                  @endforeach
                </select>
              </div>
              <?php } ?>
          ...
          <div class="box-footer">
            ...
            <a href="{{url('payment_report')}}" class="btn btn-danger">Cancel</a>
          </div>
        </form>
      </div>
    </div>
