@extends('layouts.app')
@section('title', 'Point Of Sales Report')
@section('content')
<style>
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Point Of Sales Report</li>
  </ol>
</section>
    ...
    <div class="col-md-12">
      <div class="box" style="border-top: 3px solid #ffffff;border: 2px solid #00ffc3;">
        ...
        <form class="form-horizontal" id="userForm" method="post"
          action="{{ url('download_point_of_contact_report') }}">
          {{ csrf_field() }}
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <select class="form-control select2 employee" style="width: 100%;" name="employee" id="employee">
                  ...
                  <option value="{{$u->id}}">{{$u->point_of_contact}}</option>
                  @endforeach
                </select>
              </div>
              <?php } ?>
