...
*/
    ...
    public function deactivateUser($id)
    {
        ...
        $query = \App\Employee::where('id', $id)->update(['login_active' => 1]);
        //echo "<pre/>";print_r($query);exit;
        Session::flash('alert-success', 'User account is Deactivated Successfully.');
        return redirect('user-list');
    }
    public function activateUser($id)
    {

        $query = \App\Employee::where('id', $id)->update(['login_active' => 0]);
        //echo "<pre/>";print_r($query);exit;
        Session::flash('alert-success', 'User account is Activated Successfully.');
        return redirect('user-list');
    }
}
